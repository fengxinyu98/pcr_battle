...
def CreatIDnum():
    ...
    while ((jiaoyan % 11) == 10 or result == 0):
        ...
        s = [11, 12, 13, 14, 15, 21, 22, 23, 31, 32, 33, 34, 35, 36, 37, 41, 42, 43, 44, 45, 46, 50, 51, 52, 53, 54,
             61, 62, 63, 64, 65]
        qian = s[random.randint(0, 30)] * 10000 + \
            random.randint(0, 10) * 100 + random.randint(0, 10)
        jiaoyan = 0
        zhong = random.randint(1970, 2000) * 10000 + \
            random.randint(1, 12) * 100 + random.randint(1, 28)
